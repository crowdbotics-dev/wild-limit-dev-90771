...
## Project Structure
    ...
    ├── wild_limit_dev_90771  # Django project configurations
...
1. Clone this repo and `cd wild_limit_dev_90771`
...
2. Clone this repo and `cd wild_limit_dev_90771`
